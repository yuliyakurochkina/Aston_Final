...
class CharacterRecyclerAdapter(
    private val characterList: MutableList<CharacterForListDto>,
    val itemClickListener: CharacterViewHolder.ItemClickListener
) :
    ...
    class CharacterViewHolder(itemView: View, val itemClickListener: ItemClickListener) :
